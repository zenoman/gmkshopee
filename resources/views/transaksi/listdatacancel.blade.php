              ...
              <div class="col-lg-6 col-md-6 col-xs-6 col-xs-12">
                <div class="breadcomb-wp">
                  ...
                  <div class="breadcomb-ctn">
                    <h2>Transaksi</h2>
                    <p>List Data Transaksi Dicancel</p>
                  </div>
                </div>
              </div>
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                        ...
                                        <a href="{{url('/transaksi/kirim/'.$row->no_resi)}}" onclick="return confirm('Cancel Transaksi ?')" class="btn btn-xs btn-warning"><i class="fa fa-ban"></i></a> -->
                                        <a href="{{url('/transaksi/pending/'.$row->no_resi)}}" onclick="return confirm('Kembalikan Kepending Data ?')" class="btn btn-primary btn-xs"><i class="fa fa-send"></i></a>
